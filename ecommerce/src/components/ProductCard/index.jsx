        ...
        <div className="flex flex-wrap -m-4">
          {
            products.map((product) => {
              ...
              return (
                <Link to={`/products/${id}`} key={product.id} className="lg:w-1/4 md:w-1/2 p-4 w-full border border-opacity-50 mb-4 cursor-pointer">
                  ...
                  <div className="mt-4">
                    ...
                    <h2 className="text-gray-900 title-font text-lg font-medium line-clamp-1">{title}</h2>
